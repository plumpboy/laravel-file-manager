...
<body>
  ...
  <div class="d-flex flex-row">
    <div id="tree">
      ...
      <ul class="nav nav-pills flex-column" node="0">
      </ul>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
            ...
            <input type='hidden' name='dir' id='dir' value=0>
            <input type='hidden' name='mimetype' id='mimetype'>
            <input type='hidden' name='_token' value='{{ csrf_token() }}'>

            <input type='hidden' name='sort_name' id='alphabet' value="alphabet">
            <input type='hidden' name='sort_value' id='mimetype' value="asc">
          </form>
        </div>
  ...
  <script>
    window.lang = {!! json_encode(trans('laravel-file-manager::lfm')) !!};
    window.accessToken = 'ádasdasds';
    {{-- tranfer to file --}}
    var actions = [
      {
        name: 'use',
